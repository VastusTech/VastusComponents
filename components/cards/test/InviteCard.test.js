...
describe("Get Invite Details", () => {
    describe("Friend Request", () => {
        it("Header Shows Correct Name", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "friendRequest"},
                (name) => {return "Sleeny"}, () => {}, () => {}, false, (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
    ...
    describe("Event Invite", () => {
        it("Correct event title shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "eventInvite"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Event 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
    ...
    describe("Challenge Invite", () => {
        it("Correct user name in header shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "challengeInvite"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Event 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
        ...
        it("Correct user name shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "challengeInvite"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Challenge 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
    ...
    describe("Group Invite", () => {
        it("Correct user name in header shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "groupInvite"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Group 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
    ...
    describe("Event Request", () => {
        it("Correct user name is shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "eventRequest"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Event 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
        ...
        it("Correct title is shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "eventRequest"},
                (name) => {return "Sleeny"}, () => {return "Blinky"}, (title) => {return "Group 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
    ...
    describe("Challenge Request", () => {
        it("Correct user name is shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "challengeRequest"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Event 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
        ...
        it("Correct title is shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "challengeRequest"},
                (name) => {return "Sleeny"}, () => {return "Blinky"}, (title) => {return "Challenge 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
    ...
    describe("Group Request", () => {
        it("Correct user name is shown", () => {
            const Wrapper = funCompWrapper(getInviteDetails("CL001", (string) => {return "groupRequest"},
                (name) => {return "Sleeny"}, () => {}, (title) => {return "Event 1"}, false,
                (string, func, funct) => {}, () => {}, () => {return false},
                () => {return false}, () => {}, false, () => {}));
