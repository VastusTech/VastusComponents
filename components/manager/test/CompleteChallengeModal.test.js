...
describe("Winner Buttons", () => {
  it('Correct length of component row is created based on members', () => {
    expect(winnerButtons([], "CL0001", "CH0001", () => {
    }).length).equal(0);
    expect(winnerButtons(["CL0001"], "CL0001", "CH0001", () => {
    }).length).equal(1);
    expect(winnerButtons(["CL0001", "CL0002"], "CL0001", "CH0001", () => {
    }).length).equal(2);
    expect(winnerButtons(["CL0001", "CL0002", "CL0003"], "CL0001", "CH0001", () => {
    }).length).equal(3);
  });
