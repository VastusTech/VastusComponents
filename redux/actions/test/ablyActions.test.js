...
import {
  removeChannelSubscription, addHandlerAndUnsubscription, setHandlerAndUnsubscription,
...
describe("Ably Actions", () => {
  ...
  describe("Remove Channel Subscription", () => {
    it("Removes an already subscribed channel", (done) => {
      ...
      initialStore.ably = ably(initialStore.ably, {
        type: ADD_HANDLER, asyncDispatch: () => {
        }, payload: {
