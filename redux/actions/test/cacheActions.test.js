...
import {
  fetchItem, forceFetchItem, fetchItems, forceFetchItems, fetchItemQuery, forceFetchItemQuery, putItem,
...
describe("Cache Actions", function () {
  ...
  describe("Fetch Item", () => {
    ...
    it("Fetches an existing Client with new attributes", (done) => {
      ...
      initialStore.cache = cache(initialStore.cache, {
        type: PUT_ITEM, asyncDispatch: () => {
        }, payload: {
    ...
    it("Fetches all new items", (done) => {
      reduxStore.dispatch(fetchItems(["CL0001", "CL0002", "CL0003"], "Client", ["id", "item_type", "attributeName"],
        ...
        expect(reduxStore.getActions()).excludingEvery('asyncDispatch').to.eql([
          ...
          {
            payload: {
              item: {id: "CL0001", item_type: "Client", attributeName: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0001'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0002", item_type: "Client", attributeName: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0002'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0003", item_type: "Client", attributeName: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0003'
            }, type: 'PUT_ITEM'
          },
          {type: 'SET_IS_NOT_LOADING'}
        ]);
    ...
    it("Fetches some existing items with some new attributes", (done) => {
      ...
      reduxStore.dispatch(fetchItems(["CL0001", "CL0002", "CL0003"], "Client", ["attributeName", "attributeName2"],
        ...
        expect(reduxStore.getActions()).excludingEvery('asyncDispatch').to.eql([
          ...
          {
            payload: {
              item: {id: "CL0001", item_type: "Client", attributeName: "TEST_VALUE", attributeName2: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0001'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0002", item_type: "Client", attributeName: "TEST_VALUE", attributeName2: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0002'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0003", item_type: "Client", attributeName: "TEST_VALUE", attributeName2: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0003'
            }, type: 'PUT_ITEM'
          },
          {type: 'SET_IS_NOT_LOADING'}
    ...
    it("Fetches some existing items with all new attributes", (done) => {
      ...
      reduxStore.dispatch(fetchItems(["CL0001", "CL0002", "CL0003"], "Client", ["attributeName2", "attributeName3"],
        ...
        expect(reduxStore.getActions()).excludingEvery('asyncDispatch').to.eql([
          ...
          {
            payload: {
              item: {id: "CL0001", item_type: "Client", attributeName2: "TEST_VALUE", attributeName3: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0001'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0002", item_type: "Client", attributeName2: "TEST_VALUE", attributeName3: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0002'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0003", item_type: "Client", attributeName2: "TEST_VALUE", attributeName3: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0003'
            }, type: 'PUT_ITEM'
          },
          {type: 'SET_IS_NOT_LOADING'}
    ...
    it("Fetches all existing items with some new attributes", (done) => {
      ...
      reduxStore.dispatch(fetchItems(["CL0001", "CL0002", "CL0003"], "Client", ["attributeName", "attributeName2"],
        ...
        expect(reduxStore.getActions()).excludingEvery('asyncDispatch').to.eql([
          ...
          {
            payload: {
              item: {id: "CL0001", item_type: "Client", attributeName2: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0001'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0002", item_type: "Client", attributeName2: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0002'
            }, type: 'PUT_ITEM'
          },
          {
            payload: {
              item: {id: "CL0003", item_type: "Client", attributeName2: "TEST_VALUE"},
              itemType: 'Client', id: 'CL0003'
            }, type: 'PUT_ITEM'
          },
          {type: 'SET_IS_NOT_LOADING'}
  ...
  describe("Fetch Item Query", () => {
    ...
    it("Fetches an existing item query with a null next token", (done) => {
      const initialStore = getInitialReduxStore(['cache', 'user']);
      initialStore.cache = cache(initialStore.cache, {
        type: PUT_ITEM_QUERY, asyncDispatch: () => {
        }, payload: {
  ...
  describe("Put Item", () => {
    ...
    it("Puts an existing item with new attributes", (done) => {
      ...
      reduxStore = store(initialStore);
      reduxStore.dispatch(putItem("CL0001", "Client", {
        ...
        expect(reduxStore.getActions()).excludingEvery(['asyncDispatch']).to.eql([
          {
            payload: {
              item: {attributeName2: "attributeValue", attributeName3: "attributeValue"},
              itemType: 'Client',
              id: 'CL0001'
            },
            type: 'PUT_ITEM'
    ...
    it("Puts an existing item with some existing attributes", (done) => {
      ...
      reduxStore.dispatch(putItem("CL0001", "Client", {
        ...
        expect(reduxStore.getActions()).excludingEvery(['asyncDispatch']).to.eql([
          {
            payload: {
              item: {id: "CL0001", attributeName2: "attributeValue", attributeName3: "attributeValue"},
              itemType: 'Client',
              id: 'CL0001'
            },
            type: 'PUT_ITEM'
    ...
    it("Sets an existing attribute for an existing item", (done) => {
      ...
      initialStore.cache = cache(initialStore.cache, {
        type: PUT_ITEM, asyncDispatch: () => {
          ...
          itemType: "Client",
          id: "CL0001",
          item: {id: "CL0001", item_type: "Client", attributeName: "firstAttributeValue"}
        }
      });
      reduxStore = store(initialStore);
    ...
    it("Sets the first item attribute index for a item's array", (done) => {
      ...
      initialStore.cache = cache(initialStore.cache, {
        type: PUT_ITEM, asyncDispatch: () => {
          ...
          itemType: "Client", id: "CL0001", item: {
            id: "CL0001", item_type: "Client",
