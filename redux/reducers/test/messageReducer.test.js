...
describe(ADD_MESSAGE, function () {
    it("Should add a message to a non-existent board to the front", () => {
        expect(message(undefined, {type: ADD_MESSAGE, asyncDispatch: () => {}, payload: {
                board: "BOARD",
    ...
    it("Should add a message to an existent and empty board to the front", () => {
        let messageState = message(undefined, {type: ADD_MESSAGE, asyncDispatch: () => {}, payload: {
            board: "BOARD",
            message: {message: "MESSAGE"}
        }});
        messageState = message(messageState, {type: CLEAR_BOARD, asyncDispatch: () => {}, payload: {board: "BOARD"}});
        expect(message(messageState, {type: ADD_MESSAGE, asyncDispatch: () => {}, payload: {
                board: "BOARD",
                message: {message: "MESSAGE"}
            }
        })).excludingEvery(['profilePicture', 'messageURL']).to.eql({
    ...
    it("Should add a message to an existent and non-empty board to the front", () => {
        const messageState = message(undefined, {type: ADD_MESSAGE, asyncDispatch: () => {}, payload: {
                board: "BOARD",
                message: {message: "MESSAGE"}
            }});
        expect(message(messageState, {type: ADD_MESSAGE, asyncDispatch: () => {}, payload: {
...
describe(ADD_QUERY, function () {
    it("Should add a list of messages to a non-existent board to the back", () => {
        expect(message(undefined, {type: ADD_QUERY, asyncDispatch: () => {}, payload: {
    ...
    it("Should add a list of messages to an existent and empty board to the back", () => {
        ...
        messageState = message(messageState, {type: CLEAR_BOARD, asyncDispatch: () => {}, payload: {board: "BOARD"}});
        expect(message(messageState, {type: ADD_QUERY, asyncDispatch: () => {}, payload: {
                board: "BOARD", messages: [], nextToken: null, ifSubscribed: false
            }
        })).to.eql({
            boards: { BOARD: [] },
...
describe(SET_BOARD_READ, function () {
    it("Should set the board read for a board with one message", () => {
        ...
        expect(message(messageState, {type: SET_BOARD_READ, asyncDispatch: () => {}, payload: {
    ...
    it("Should set the board read for a board with more than one message", () => {
        ...
        messageState = message(messageState, {type: ADD_MESSAGE, asyncDispatch: () => {}, payload: {
            board: "BOARD",
            message: {message: "MESSAGE"}
        }});
        expect(message(messageState, {type: SET_BOARD_READ, asyncDispatch: () => {}, payload: {
    ...
    it("Should do nothing for a non-existent board", () => {
        expect(message(undefined, {type: SET_BOARD_READ, asyncDispatch: () => {}, payload: {
                board: "BOARD", userID: "CL0001"
            }
        })).to.eql({
            boards: {},
...
describe(CLEAR_BOARD, function () {
    it("Should clear a board with messages", () => {
        ...
        expect(message(messageState, {type: CLEAR_BOARD, asyncDispatch: () => {}, payload: {
            board: "BOARD"
        }})).to.eql({
            boards: {},
            boardLRUHandler: [],
    ...
    it("Should clear a non-existent board", () => {
        expect(message(undefined, {type: CLEAR_BOARD, asyncDispatch: () => {}, payload: {
            board: "BOARD"
        }})).to.eql({
            boards: {},
            boardLRUHandler: [],
...
describe(CLEAR_ALL_BOARDS, function () {
    it("Should clear a non-empty board cache", () => {
        ...
        expect(message(messageState, {type: CLEAR_ALL_BOARDS, asyncDispatch: () => {}})).to.eql({
            boards: {},
            boardLRUHandler: [],
            boardNextTokens: {},
            boardIfFirsts: {},
    ...
    it("Should clear an empty board cache", () => {
        expect(message(undefined, {type: CLEAR_ALL_BOARDS, asyncDispatch: () => {}})).to.eql({
            boards: {},
            boardLRUHandler: [],
            boardNextTokens: {},
            boardIfFirsts: {},
