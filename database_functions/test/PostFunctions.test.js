...
describe("high level functions", () => {
    ...
    it("Should create a bare post correctly", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"CREATE\",\"itemType\":\"Post\",\"createPostRequest\":" +
            "{\"by\":\"BY\",\"description\":\"DESCRIPTION\",\"access\":\"ACCESS\",\"postType\":null,\"about\"" +
            ":null,\"picturePaths\":null,\"videoPaths\":null}}");
    });
    ...
    it("Should create an optional post correctly", () => {
        expect(PostFunctions.createPostOptional(
            ...
            "{\"by\":\"BY\",\"description\":\"DESCRIPTION\",\"access\":\"ACCESS\",\"postType\":null," +
            "\"about\":null,\"picturePaths\":[\"PICTUREPATH\"],\"videoPaths\":[\"VIDEOPATH\"]}}");
    });
    ...
    it("Should create a bare share item post correctly", () => {
        expect(PostFunctions.createShareItemPost(
            ...
            "{\"by\":\"BY\",\"description\":\"DESCRIPTION\",\"access\":\"ACCESS\",\"postType\":\"ITEMTYPE\"," +
            "\"about\":\"ITEMID\",\"picturePaths\":null,\"videoPaths\":null}}");
    });
    ...
    it("Should create an optional share item post correctly", () => {
        expect(PostFunctions.createShareItemPostOptional(
            ...
            "{\"by\":\"BY\",\"description\":\"DESCRIPTION\",\"access\":\"ACCESS\",\"postType\":\"ITEMTYPE\"," +
            "\"about\":\"ITEMID\",\"picturePaths\":[\"PICTUREPATH\"],\"videoPaths\":[\"VIDEOPATH\"]}}");
    });
    ...
    it("Should update a post's description correctly", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATESET\",\"itemType\":\"Post\",\"identifiers\":" +
            "[\"POSTID\"],\"attributeName\":\"description\",\"attributeValues\":[\"DESCRIPTION\"]}");
    });
    ...
    it("Should update a post's access correctly", () => {
        expect(PostFunctions.updateAccess(
            ...
            "[\"POSTID\"],\"attributeName\":\"access\",\"attributeValues\":[\"ACCESS\"]}");
    });
    ...
    it("Should add a picture to a post correctly", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEADD\",\"itemType\":\"Post\",\"identifiers\":" +
            "[\"POSTID\"],\"attributeName\":\"picturePaths\",\"attributeValues\":[\"PICTUREPATH\"]}");
    });
    ...
    it("Should add a video to a post correctly", () => {
        expect(PostFunctions.addVideo(
            ...
            "[\"POSTID\"],\"attributeName\":\"videoPaths\",\"attributeValues\":[\"VIDEOPATH\"]}");
    });
    ...
    it("Should remove a picture from a post correctly", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEREMOVE\",\"itemType\":\"Post\",\"identifiers\":" +
            "[\"POSTID\"],\"attributeName\":\"picturePaths\",\"attributeValues\":[\"PICTUREPATH\"]}");
    });
...
describe("low level functions", () => {
    it("Should send a create payload for a post correctly", () => {
        expect(PostFunctions.create(
            ...
            "{\"by\":\"BY\",\"description\":\"DESCRIPTION\",\"access\":\"ACCESS\",\"postType\":\"POSTTYPE\"," +
            "\"about\":\"ABOUT\",\"picturePaths\":[\"PICTUREPATH\"],\"videoPaths\":[\"VIDEOPATH\"]}}");
    });
    it("Should send an update add payload for a post correctly", () => {
        expect(PostFunctions.updateAdd(
            ...
            "[\"POSTID\"],\"attributeName\":\"ATTRIBUTENAME\",\"attributeValues\":[\"ATTRIBUTEVALUE\"]}");
    });
...
// static delete(fromID, challengeID, successHandler, failureHandler) {
    it("Should send a delete payload for a post correctly", () => {
        expect(PostFunctions.delete(
            "FROMID", "POSTID",
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"DELETE\",\"itemType\":\"Post\",\"identifiers\":" +
            "[\"POSTID\"]}");
    });
});
