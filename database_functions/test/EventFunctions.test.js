...
describe("high level functions", () => {
    ...
    it("Should create a bare minimum event correctly", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"CREATE\",\"itemType\":\"Event\",\"createEventRequest\":" +
            "{\"owner\":\"OWNER\",\"time\":\"TIME\",\"capacity\":\"CAPACITY\",\"address\":\"ADDRESS\",\"title\":\"" +
            "TITLE\",\"description\":null,\"tags\":[\"TAG1\",\"TAG2\",\"TAG3\"],\"members\":null,\"access\":\"" +
            "ACCESS\",\"restriction\":null,\"challenge\":null,\"group\":null}}");
    });
    ...
    it("Should create an optional event correctly", () => {
        expect(EventFunctions.createEventOptional(
            ...
            "{\"owner\":\"OWNER\",\"time\":\"TIME\",\"capacity\":\"CAPACITY\",\"address\":\"ADDRESS\",\"title\":\"" +
            "TITLE\",\"description\":\"DESCRIPTION\",\"tags\":[\"TAG1\",\"TAG2\",\"TAG3\"],\"members\":[\"MEMBER1" +
            "\",\"MEMBER2\",\"MEMBER3\"],\"access\":\"ACCESS\",\"restriction\":\"RESTRICTION\",\"challenge\":null" +
            ",\"group\":null}}");
    });
    ...
    it("Should create a bare minimum challenge event correctly", () => {
        expect(EventFunctions.createChallengeEvent(
            ...
            ":{\"owner\":\"OWNER\",\"time\":\"TIME\",\"capacity\":\"CAPACITY\",\"address\":\"ADDRESS\",\"title\":" +
            "\"TITLE\",\"description\":null,\"tags\":[\"TAG1\",\"TAG2\",\"TAG3\"],\"members\":null,\"access\":\"" +
            "ACCESS\",\"restriction\":null,\"challenge\":\"CHALLENGEID\",\"group\":null}}");
    });
    ...
    it("Should create an optional challenge event correctly", () => {
        expect(EventFunctions.createChallengeEventOptional(
            ...
            "{\"owner\":\"OWNER\",\"time\":\"TIME\",\"capacity\":\"CAPACITY\",\"address\":\"ADDRESS\",\"title\":" +
            "\"TITLE\",\"description\":\"DESCRIPTION\",\"tags\":[\"TAG1\",\"TAG2\",\"TAG3\"],\"members\":[" +
            "\"MEMBER1\",\"MEMBER2\",\"MEMBER3\"],\"access\":\"ACCESS\",\"restriction\":\"RESTRICTION\",\"" +
            "challenge\":\"CHALLENGEID\",\"group\":null}}");
    });
    ...
    it("Should create a bare minimum group event correctly", () => {
        expect(EventFunctions.createGroupEvent(
            ...
            "{\"owner\":\"OWNER\",\"time\":\"TIME\",\"capacity\":\"CAPACITY\",\"address\":\"ADDRESS\",\"title\":" +
            "\"TITLE\",\"description\":null,\"tags\":\"ACCESS\",\"members\":null,\"access\":[\"TAG1\",\"TAG2\"," +
            "\"TAG3\"],\"restriction\":null,\"challenge\":null,\"group\":\"GROUPID\"}}");
    });
    ...
    it("Should update an event to private", () => {
        expect(EventFunctions.updateToPrivate(
            "FROMID", "EVENTID"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATESET\",\"itemType\":\"Event\",\"identifiers\":" +
            "[\"EVENTID\"],\"attributeName\":\"access\",\"attributeValues\":[\"private\"]}");
    });
    ...
    it("Should update an event to public", () => {
        expect(EventFunctions.updateToPublic(
            ...
            "[\"EVENTID\"],\"attributeName\":\"access\",\"attributeValues\":[\"public\"]}");
    });
    ...
    it("Should update an event to invite only", () => {
        expect(EventFunctions.updateToInviteOnly(
            "FROMID", "EVENTID"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEADD\",\"itemType\":\"Event\",\"identifiers\":" +
            "[\"EVENTID\"],\"attributeName\":\"restriction\",\"attributeValues\":[\"invite\"]}");
    });
    ...
    it("Should update an event to unrestricted", () => {
        expect(EventFunctions.updateToUnrestricted(
            ...
            "[\"EVENTID\"],\"attributeName\":\"restriction\",\"attributeValues\":[null]}");
    });
    ...
    it("Should add a tag to the event", () => {
        expect(EventFunctions.addTag(
            ...
            "[\"EVENTID\"],\"attributeName\":\"tags\",\"attributeValues\":[\"TAG\"]}");
    });
    ...
    it("Should remove a tag from the event", () => {
        expect(EventFunctions.removeTag(
            "FROMID", "EVENTID", "TAG"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEREMOVE\",\"itemType\":\"Event\",\"identifiers\":" +
            "[\"EVENTID\"],\"attributeName\":\"tags\",\"attributeValues\":[\"TAG\"]}");
    });
    ...
    it("Should add a member to the event", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEADD\",\"itemType\":\"Message\",\"identifiers\":" +
            "[\"MEMBER\"],\"attributeName\":\"scheduledEvents\",\"attributeValues\":[\"EVENTID\"]}");
    });
    ...
    it("Should remove a member from the event", () => {
        expect(EventFunctions.removeMember(
            "FROMID", "EVENTID", "MEMBER"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEREMOVE\",\"itemType\":\"Message\",\"identifiers\":" +
            "[\"MEMBER\"],\"attributeName\":\"scheduledEvents\",\"attributeValues\":[\"EVENTID\"]}");
    });
    ...
    it("Should update an event's address", () => {
        expect(EventFunctions.updateAddress(
            ...
            "[\"EVENTID\"],\"attributeName\":\"address\",\"attributeValues\":[\"ADDRESS\"]}");
    });
    ...
    it("Should update an event's capacity", () => {
        expect(EventFunctions.updateCapacity(
            ...
            "[\"EVENTID\"],\"attributeName\":\"capacity\",\"attributeValues\":[\"CAPACITY\"]}");
    });
    ...
    it("Should update an event's title", () => {
        expect(EventFunctions.updateTitle(
            ...
            "[\"EVENTID\"],\"attributeName\":\"title\",\"attributeValues\":[\"TITLE\"]}");
    });
    ...
    it("Should update an event's description", () => {
        expect(EventFunctions.updateDescription(
            ...
            "[\"EVENTID\"],\"attributeName\":\"description\",\"attributeValues\":[\"DESCRIPTION\"]}");
    });
});
describe("low level functions", () => {
    it("Should send a create payload for an event correctly", () => {
        expect(EventFunctions.create(
            ...
            "\"TITLE\",\"description\":\"DESCRIPTION\",\"tags\":[\"TAG1\",\"TAG2\",\"TAG3\"],\"members\":[\"" +
            "MEMBER1\",\"MEMBER2\",\"MEMBER3\"],\"access\":\"ACCESS\",\"restriction\":\"RESTRICTION\",\"" +
            "challenge\":\"CHALLENGEID\",\"group\":\"GROUPID\"}}");
    });
// static updateAdd(fromID, challengeID, attributeName, attributeValue, successHandler, failureHandler) {
    it("Should send an update add payload for an event correctly", () => {
        expect(EventFunctions.updateAdd(
            ...
            "[\"EVENTID\"],\"attributeName\":\"ATTRIBUTENAME\",\"attributeValues\":[\"ATTRIBUTEVALUE\"]}");
    });
...
// static delete(fromID, challengeID, successHandler, failureHandler) {
    it("Should send a delete payload for an event correctly", () => {
        expect(EventFunctions.delete(
            "FROMID", "EVENTID",
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"DELETE\",\"itemType\":\"Event\",\"identifiers\":" +
            "[\"EVENTID\"]}");
    });
});
