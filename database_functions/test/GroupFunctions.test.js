...
describe("high level functions", () => {
    ...
    it("Should create a bare minimum group correctly", () => {
        ...
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"CREATE\",\"itemType\":\"Group\",\"createGroupRequest" +
            "\":{\"title\":\"TITLE\",\"description\":\"DESCRIPTION\",\"motto\":null,\"owners\":null,\"members" +
            "\":null,\"tags\":null,\"access\":\"ACCESS\",\"restriction\":null,\"groupImagePath\":null}}");
    });
    ...
    it("Should create an optional group correctly", () => {
        expect(GroupFunctions.createGroupOptional(
            ...
            "{\"title\":\"TITLE\",\"description\":\"DESCRIPTION\",\"motto\":\"MOTTO\",\"owners\":[\"OWNER1\",\"" +
            "OWNER2\",\"OWNER3\"],\"members\":[\"MEMBER1\",\"MEMBER2\",\"MEMBER3\"],\"tags\":[\"TAG1\",\"TAG2\"," +
            "\"TAG3\"],\"access\":\"ACCESS\",\"restriction\":\"RESTRICTION\",\"groupImagePath\":\"groupImage\"}}");
    });
    ...
    it("Should update a group to private", () => {
        expect(GroupFunctions.updateToPrivate(
            "FROMID", "GROUPID"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATESET\",\"itemType\":\"Group\",\"identifiers\":" +
            "[\"GROUPID\"],\"attributeName\":\"access\",\"attributeValues\":[\"private\"]}");
    });
    ...
    it("Should update a group to public", () => {
        expect(GroupFunctions.updateToPublic(
            ...
            "[\"GROUPID\"],\"attributeName\":\"access\",\"attributeValues\":[\"public\"]}");
    });
    ...
    it("Should update a group to invite only", () => {
        expect(GroupFunctions.updateToInviteOnly(
            "FROMID", "GROUPID"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEADD\",\"itemType\":\"Group\",\"identifiers\":" +
            "[\"GROUPID\"],\"attributeName\":\"restriction\",\"attributeValues\":[\"invite\"]}");
    });
    ...
    it("Should update a group to unrestricted", () => {
        expect(GroupFunctions.updateToUnrestricted(
            ...
            "[\"GROUPID\"],\"attributeName\":\"restriction\",\"attributeValues\":[null]}");
    });
    ...
    it("Should add a tag to a group", () => {
        expect(GroupFunctions.addTag(
            ...
            "[\"GROUPID\"],\"attributeName\":\"tags\",\"attributeValues\":[\"TAG\"]}");
    });
    ...
    it("Should remove a tag from a group", () => {
        expect(GroupFunctions.removeTag(
            "FROMID", "GROUPID", "TAG"
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"UPDATEREMOVE\",\"itemType\":\"Group\",\"identifiers\":" +
            "[\"GROUPID\"],\"attributeName\":\"tags\",\"attributeValues\":[\"TAG\"]}");
    });
    ...
    it("Should add a member to a group", () => {
        expect(GroupFunctions.addMember(
            ...
            "[\"MEMBER\"],\"attributeName\":\"groups\",\"attributeValues\":[\"GROUPID\"]}");
    });
    ...
    it("Should update the title of a group", () => {
        expect(GroupFunctions.updateTitle(
            ...
            "[\"GROUPID\"],\"attributeName\":\"title\",\"attributeValues\":[\"TITLE\"]}");
    });
    ...
    it("Should update the motto of a group", () => {
        expect(GroupFunctions.updateMotto(
            ...
            "[\"GROUPID\"],\"attributeName\":\"motto\",\"attributeValues\":[\"MOTTO\"]}");
    });
    ...
    it("Should update the description of a group", () => {
        expect(GroupFunctions.updateDescription(
            ...
            "[\"GROUPID\"],\"attributeName\":\"description\",\"attributeValues\":[\"DESCRIPTION\"]}");
    });
    ...
    it("Should update the group image of a group", () => {
        expect(GroupFunctions.updateGroupImage(
            ...
            "[\"GROUPID\"],\"attributeName\":\"groupImagePath\",\"attributeValues\":[\"groupImage\"]}");
    });
});
...
// static updateAdd(fromID, challengeID, attributeName, attributeValue, successHandler, failureHandler) {
    it("Should send an update add payload for a group correctly", () => {
        expect(GroupFunctions.updateAdd(
            ...
            "[\"GROUPID\"],\"attributeName\":\"ATTRIBUTENAME\",\"attributeValues\":[\"ATTRIBUTEVALUE\"]}");
    });
...
// static delete(fromID, challengeID, successHandler, failureHandler) {
    it("Should send a delete payload for a group correctly", () => {
        expect(GroupFunctions.delete(
            "FROMID", "GROUPID",
        )).to.be.equal("{\"fromID\":\"FROMID\",\"action\":\"DELETE\",\"itemType\":\"Group\",\"identifiers\":" +
            "[\"GROUPID\"]}");
    });
});
