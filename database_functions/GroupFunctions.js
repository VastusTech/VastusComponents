...
class GroupFunctions {
    ...
    static createGroup(fromID, title, description, successHandler, failureHandler) {
        return this.create(fromID, title, description, null, null, null, null, null, successHandler, failureHandler);
    }
    static createGroupOptional(fromID, title, description, access, restriction, owners, members, tags, successHandler, failureHandler) {
        return this.create(fromID, title, description, access, restriction, owners, members, tags, successHandler, failureHandler);
    }
